...
This folder defines all source code for the 'Pipelines with CDC tutorial' pipeline:
...
* Take a look at the sample under "sample_users_pipelines_with_cdc_tutorial.py" to get familiar with the syntax.
